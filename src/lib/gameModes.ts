...
export const GAME_MODES: GameModeMeta[] = [
  ...
  },
  {
    ...
    name: 'Farm Life',
    engine: 'Selection',
    description: 'Stardew-inspired farming! Plant, water, harvest crops on a 4x4 grid. Feed animals!',
    emoji: '🚜',
    minTerms: 4,
    maxTerms: 12,
    accent: '#22c55e',
  },
  {
    ...
    engine: 'Selection',
    description: 'Turn-based RPG battle! Cast spells to defeat monsters. Match weakness for double damage!',
    emoji: '⚔️',
    minTerms: 4,
    maxTerms: 12,
    accent: '#e94560',
  },
  {
    ...
    name: 'Tower Defense',
    engine: 'Selection',
    description: 'Build towers to defend your castle! Tap the correct word to shoot enemies!',
    emoji: '🏰',
    minTerms: 4,
    maxTerms: 12,
    accent: '#533483',
  },
  {
    ...
    name: 'Rhythm Tap',
    engine: 'Selection',
    description: 'Tap vocabulary words as they fall to the beat! Perfect timing = bonus points!',
    emoji: '🎵',
    minTerms: 4,
    maxTerms: 12,
    accent: '#a78bfa',
  },
  {
    ...
    name: 'Space Explorer',
    engine: 'Selection',
    description: 'Explore star systems and discover planets by matching vocabulary words!',
    emoji: '🚀',
    minTerms: 4,
    maxTerms: 12,
    accent: '#60a5fa',
  },
  {
    ...
    engine: 'Selection',
    description: 'Live an interactive story! Choose what happens next and learn vocabulary!',
    emoji: '📖',
    minTerms: 4,
    maxTerms: 12,
    accent: '#fbbf24',
  },
  {
    ...
    name: 'Treasure Hunt',
    engine: 'Selection',
    description: 'Dig for treasure on a grid! Use hints to find hidden jewels and answer vocab!',
    emoji: '🗺️',
    minTerms: 4,
    maxTerms: 12,
    accent: '#f59e0b',
