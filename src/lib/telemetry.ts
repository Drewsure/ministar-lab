...
const MIN_PER_QUESTION_MS = 200; // AAAA: was 400 — too strict for fast games like SpotIt (15 rounds in 150s = 10s/round, but fast kids can answer in 200ms). 200ms still catches bots.
