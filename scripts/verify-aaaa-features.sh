...
check_lines "BaseEngine" "src/game/BaseEngine.ts" 992
check_lines "KidsJuice" "src/game/KidsJuice.ts" 308
check_lines "audio.ts" "src/lib/audio.ts" 339
check_lines "page.tsx" "src/app/page.tsx" 594
check_lines "Juice.ts" "src/game/Juice.ts" 1330
check_lines "AirplaneScene" "src/game/scenes/AirplaneScene.ts" 643
check_lines "QuizScene" "src/game/scenes/QuizScene.ts" 747
check_lines "GameshowScene" "src/game/scenes/GameshowScene.ts" 657
check_lines "SnakingScene" "src/game/scenes/SnakingScene.ts" 571
check_lines "SpinWheelScene" "src/game/scenes/SpinWheelScene.ts" 295
check_lines "EndlessRunnerScene" "src/game/scenes/EndlessRunnerScene.ts" 201
check_lines "WhackAMoleScene" "src/game/scenes/WhackAMoleScene.ts" 305
check_lines "BalloonPopScene" "src/game/scenes/BalloonPopScene.ts" 328
check_lines "RhythmTapScene" "src/game/scenes/RhythmTapScene.ts" 371
check_lines "TowerDefenseScene" "src/game/scenes/TowerDefenseScene.ts" 407
check_lines "MazeChaseScene" "src/game/scenes/MazeChaseScene.ts" 906
check_lines "AnagramScene" "src/game/scenes/AnagramScene.ts" 358
check_lines "CrosswordScene" "src/game/scenes/CrosswordScene.ts" 528
check_lines "FlashCardsScene" "src/game/scenes/FlashCardsScene.ts" 306
check_lines "GroupSortScene" "src/game/scenes/GroupSortScene.ts" 279
check_lines "LabelItScene" "src/game/scenes/LabelItScene.ts" 70
check_lines "MatchUpScene" "src/game/scenes/MatchUpScene.ts" 312
check_lines "MemoryMatchScene" "src/game/scenes/MemoryMatchScene.ts" 347
check_lines "MonsterFighterScene" "src/game/scenes/MonsterFighterScene.ts" 381
check_lines "PhysicsPuzzlerScene" "src/game/scenes/PhysicsPuzzlerScene.ts" 128
check_lines "RescueQuestScene" "src/game/scenes/RescueQuestScene.ts" 133
check_lines "SpeakItScene" "src/game/scenes/SpeakItScene.ts" 133
check_lines "SpotItScene" "src/game/scenes/SpotItScene.ts" 380
check_lines "StarFarmScene" "src/game/scenes/StarFarmScene.ts" 1757
check_lines "StoryAdventureScene" "src/game/scenes/StoryAdventureScene.ts" 299
check_lines "TrainingAcademyScene" "src/game/scenes/TrainingAcademyScene.ts" 123
check_lines "TreasureHuntScene" "src/game/scenes/TreasureHuntScene.ts" 304
check_lines "TypeAnswerScene" "src/game/scenes/TypeAnswerScene.ts" 334
check_lines "WordsearchScene" "src/game/scenes/WordsearchScene.ts" 285
check_lines "FarmLifeScene" "src/game/scenes/FarmLifeScene.ts" 521
echo ""
